...
enum OBJID{BACKGROUND, PLAYER, MONSTER, INTERACTION, ENTER,POTAL, WALL, ITEM,EVENT,OBJID_END};
enum EVENT { BUTTON, CHECK, OPEN, CLOSE, EVENT_END };
...
enum STATE { IDLE, WALK, ATTACK, PUSH, DAMAGED,STATE_END };
